...
Usage:
    uv run adws/adw_prompt.py "<prompt or path/to/prompt.md>" --base <branch> [--agent builder] [--config adws/adw_sssf_config/sssf.config.yaml] [--adw-id a1b2c3d4]
...
from adw_modules import session, utils
...
def main(prompt: str, agent: str = "builder",
    ...
    cfg, repo_root = session.bootstrap(config, [agent])
...
if __name__ == "__main__":
    ...
    sys.exit(main(args.prompt, args.agent, args.config, args.adw_id, args.base))
