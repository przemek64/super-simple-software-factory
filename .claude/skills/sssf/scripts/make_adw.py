...
Usage:
    uv run adws/adw_{name}.py "<prompt or path/to/prompt.md>" --base <branch> [--config adws/adw_sssf_config/sssf.config.yaml] [--adw-id a1b2c3d4]
...
def main() -> int:
    ...
    print(f"run: uv run adws/adw_{args.name}.py \"your request\" --base main")
    return 0
